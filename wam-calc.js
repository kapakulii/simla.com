...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateActiveElement(element, containerId) {
        document.querySelectorAll(`#${containerId} .wam-calc_input-is-active`).forEach(el => el.classList.remove('wam-calc_input-is-active'));
    ...
    document.getElementById('10000').closest('.wam-calc_radio-btn').classList.add('wam-calc_input-is-active');
    document.getElementById('60').closest('.wam-calc_radio-btn').classList.add('wam-calc_input-is-active');
